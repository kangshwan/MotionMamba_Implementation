...
from mamba_attn_diff.models.architectures.motion_mamba1_denoiser import(
    HTM,
    BSM,
    MotionMambaDenoiser
)
...
class MotionMamba(BaseModel):
    ...
    def __init__(self, cfg, datamodule, **kwargs):
        ...
        self.denoiser = instantiate_from_config(cfg.model.mamba1_denoiser)
    ...
    def _diffusion_reverse(self, encoder_hidden_states, lengths=None):
        ...
        # print('latent:',torch.isnan(latents).any())
        # set timesteps
